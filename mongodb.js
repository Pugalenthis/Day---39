...
db.tasks.aggregate([ {$lookup : {from: "attendance",localField:"user_id",foreignField:"user_id",as :"attendance"}},{$match:{ $and :[{ submitted :false },{"attendance.present" :false}] }} ]).pretty()
